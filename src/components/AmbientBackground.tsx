 ...
 * Simplified on touch/reduced-motion to avoid mobile lag (fewer blurs and animations).
 */
export const AmbientBackground = () => {
  ...
  useEffect(() => {
    ...
    setLightMode(isTouch || prefersReduced);
  }, []);
  ...
  if (lightMode) {
    return (
      <div
        ...
        aria-hidden="true"
      >
        {/* Static grid only — no animation, no blur */}
        <div
